package com.ramazanalarmandcalender.scheduler;
...
import com.ramazanalarmandcalender.SalaatTimesActivity;
...
public class SalaatSchedulingService extends IntentService implements Constants {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (AppSettings.getInstance(this).getTimeFormatFor(0) == PrayTime.TIME_12) {
