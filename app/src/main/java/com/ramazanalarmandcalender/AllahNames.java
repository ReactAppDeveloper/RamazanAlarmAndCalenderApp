...
public class AllahNames extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_allahnames);
        this.setTitle("Allah Names");
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.re);
        mLayoutManager = new LinearLayoutManager(AllahNames.this);
        ...
        RecyclerAdapter adapter=new RecyclerAdapter(AllahNames.this,arrayList);
