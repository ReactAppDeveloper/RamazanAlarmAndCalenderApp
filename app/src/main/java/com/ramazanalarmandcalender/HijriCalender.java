...
import com.ramazanalarmandcalender.sahaab.hijri.hijricalendar.CaldroidListener;
...
public class HijriCalender extends AppCompatActivity {
    ...
    private void setCustomResourceForDates() {
        ...
        if (caldroidFragment != null) {
            caldroidFragment.setBackgroundResourceForDate(R.color.teal_primary_dark,
                    blueDate);
            caldroidFragment.setBackgroundResourceForDate(R.color.tealprimarycolor,
                    greenDate);
